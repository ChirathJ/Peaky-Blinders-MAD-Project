...
public class DetailsSupplier extends AppCompatActivity {
    ...
    ImageButton update_button, updatesupplier_button, delete_button, back_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view1) {
                Intent intent1 = new Intent(DetailsSupplier.this, MainActivity.class);
    ...
    void confirmDialog(){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                MyDatabaseHelper myDB = new MyDatabaseHelper(DetailsSupplier.this);
